...
public class Shortcuts {
    ...
    final public static IfThenElse IfThenElse(@NotNull Expression expression, @NotNull Statement thenStatement, @NotNull Statement elseStatement) {
        return new IfThenElse(expression, thenStatement, elseStatement);
    }
